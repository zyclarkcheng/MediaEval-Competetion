...
# 
from parsing2vector import getDictFrom,dict2vector,get_score_ranking_from,count_frame,get_ranking_in_video
...
print('errorrate',np.sum([y_predict!=y_test])/len(y_test))
for i in y_predict:
    print(i)
...
print('average_distance',average_distance(ranks,y_test_ranking)/len(ranks))
